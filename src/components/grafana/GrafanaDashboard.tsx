        ...
        <div className="gf-main-container" style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
          ...
          <main className="gf-page" id="pageContent">
            ...
            <div className="gf-canvas">
              ...
              {/* Hero Row — Profile intro */}
              <div className="gf-hero-row">
                <div className="gf-hero-panel">
                  {/* Left: identity */}
                  <div className="gf-hero-identity">
                    <div className="gf-hero-avatar">KA</div>
                    <div className="gf-hero-id-text">
                      <h1 className="gf-hero-name">{PROFILE.name}</h1>
                      <div className="gf-hero-title-row">
                        <span className="gf-hero-role">{PROFILE.title} @ Meditab Software Inc.</span>
                        {/* <span className="gf-hero-badge gf-hero-badge--green">● Open to Work</span> */}
                        {/* <span className="gf-hero-badge gf-hero-badge--blue"></span> */}
                      </div>
                      <p className="gf-hero-bio">
                        B.Tech CSE @ Parul University · Building production-grade infrastructure with Docker, Kubernetes, Grafana stack, and GitLab CI/CD on AWS and Bare Metal servers. Passionate about observability, reliability, and automation.
                      </p>
                    </div>
                  </div>

                  {/* Divider */}
                  <div className="gf-hero-vdiv" />

                  {/* Right: skills + links */}
                  <div className="gf-hero-right">
                    <div className="gf-hero-skills">
                      {SKILLS.slice(0, 6).map(s => (
                        <span key={s.name} className="gf-hero-skill-chip" style={{ borderColor: s.color, color: s.color }}>
                          {s.name}
                        </span>
                      ))}
                    </div>
                    <div className="gf-hero-links">
                      <a href={CONTACT.github.url} target="_blank" rel="noopener noreferrer" className="gf-hero-link gf-hero-link--gh">
                      ...
                      <a href={CONTACT.linkedin.url} target="_blank" rel="noopener noreferrer" className="gf-hero-link gf-hero-link--li">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                        linkedin/kavish-ambani
                      </a>
                      <button className="gf-hero-link gf-hero-link--email" onClick={handleCopyEmail}>
